...
NONA_OPTS=
ENBLEND_OPTS= -f1134x1506+115+147
...
EXIFTOOL_INFO_ARGS="-Software=Hugin 2012.0.0.a6e4184ad538 built by Matthew Petroff" "-UserComment<$${UserComment}&\#xd;&\#xa;Projection: Rectilinear (0)&\#xd;&\#xa;FOV: 12 x 16&\#xd;&\#xa;Ev: 0.32" -f

# the output panorama
LDR_REMAPPED_PREFIX=c0018_r0000-c0018_r0001
LDR_REMAPPED_PREFIX_SHELL="c0018_r0000-c0018_r0001"
HDR_STACK_REMAPPED_PREFIX=c0018_r0000-c0018_r0001_hdr_
HDR_STACK_REMAPPED_PREFIX_SHELL="c0018_r0000-c0018_r0001_hdr_"
LDR_EXPOSURE_REMAPPED_PREFIX=c0018_r0000-c0018_r0001_exposure_layers_
LDR_EXPOSURE_REMAPPED_PREFIX_SHELL="c0018_r0000-c0018_r0001_exposure_layers_"
PROJECT_FILE=C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0000-c0018_r0001.pto
PROJECT_FILE_SHELL="C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0000-c0018_r0001.pto"
LDR_BLENDED=c0018_r0000-c0018_r0001.tif
LDR_BLENDED_SHELL="c0018_r0000-c0018_r0001.tif"
LDR_STACKED_BLENDED=c0018_r0000-c0018_r0001_fused.tif
LDR_STACKED_BLENDED_SHELL="c0018_r0000-c0018_r0001_fused.tif"
LDR_EXPOSURE_LAYERS_FUSED=c0018_r0000-c0018_r0001_blended_fused.tif
LDR_EXPOSURE_LAYERS_FUSED_SHELL="c0018_r0000-c0018_r0001_blended_fused.tif"
HDR_BLENDED=c0018_r0000-c0018_r0001_hdr.exr
HDR_BLENDED_SHELL="c0018_r0000-c0018_r0001_hdr.exr"

# first input image
INPUT_IMAGE_1=C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0000.jpg
INPUT_IMAGE_1_SHELL="C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0000.jpg"

# all input images
INPUT_IMAGES=C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0000.jpg\
C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0001.jpg
INPUT_IMAGES_SHELL="C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0000.jpg"\
"C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0001.jpg"

# remapped images
LDR_LAYERS=c0018_r0000-c0018_r00010000.tif\
c0018_r0000-c0018_r00010001.tif
LDR_LAYERS_SHELL="c0018_r0000-c0018_r00010000.tif"\
"c0018_r0000-c0018_r00010001.tif"

# remapped images (hdr)
HDR_LAYERS=c0018_r0000-c0018_r0001_hdr_0000.exr\
c0018_r0000-c0018_r0001_hdr_0001.exr
HDR_LAYERS_SHELL="c0018_r0000-c0018_r0001_hdr_0000.exr"\
"c0018_r0000-c0018_r0001_hdr_0001.exr"

# remapped maxval images
HDR_LAYERS_WEIGHTS=c0018_r0000-c0018_r0001_hdr_0000_gray.pgm\
c0018_r0000-c0018_r0001_hdr_0001_gray.pgm
HDR_LAYERS_WEIGHTS_SHELL="c0018_r0000-c0018_r0001_hdr_0000_gray.pgm"\
"c0018_r0000-c0018_r0001_hdr_0001_gray.pgm"

# stacked hdr images
HDR_STACK_0=c0018_r0000-c0018_r0001_stack_hdr_0000.exr
HDR_STACK_0_SHELL="c0018_r0000-c0018_r0001_stack_hdr_0000.exr"
HDR_STACK_0_INPUT=c0018_r0000-c0018_r0001_hdr_0000.exr
HDR_STACK_0_INPUT_SHELL="c0018_r0000-c0018_r0001_hdr_0000.exr"
HDR_STACK_1=c0018_r0000-c0018_r0001_stack_hdr_0001.exr
HDR_STACK_1_SHELL="c0018_r0000-c0018_r0001_stack_hdr_0001.exr"
HDR_STACK_1_INPUT=c0018_r0000-c0018_r0001_hdr_0001.exr
HDR_STACK_1_INPUT_SHELL="c0018_r0000-c0018_r0001_hdr_0001.exr"
...
LDR_EXPOSURE_LAYER_0=c0018_r0000-c0018_r0001_exposure_0000.tif
LDR_EXPOSURE_LAYER_0_SHELL="c0018_r0000-c0018_r0001_exposure_0000.tif"
LDR_EXPOSURE_LAYER_0_INPUT=c0018_r0000-c0018_r0001_exposure_layers_0000.tif\
c0018_r0000-c0018_r0001_exposure_layers_0001.tif
LDR_EXPOSURE_LAYER_0_INPUT_SHELL="c0018_r0000-c0018_r0001_exposure_layers_0000.tif"\
"c0018_r0000-c0018_r0001_exposure_layers_0001.tif"
LDR_EXPOSURE_LAYER_0_INPUT_PTMENDER=c0018_r0000-c0018_r00010000.tif\
c0018_r0000-c0018_r00010001.tif
LDR_EXPOSURE_LAYER_0_INPUT_PTMENDER_SHELL="c0018_r0000-c0018_r00010000.tif"\
"c0018_r0000-c0018_r00010001.tif"
LDR_EXPOSURE_LAYER_0_EXPOSURE=0.321077
...
LDR_EXPOSURE_LAYERS_REMAPPED=c0018_r0000-c0018_r0001_exposure_layers_0000.tif\
c0018_r0000-c0018_r0001_exposure_layers_0001.tif
LDR_EXPOSURE_LAYERS_REMAPPED_SHELL="c0018_r0000-c0018_r0001_exposure_layers_0000.tif"\
"c0018_r0000-c0018_r0001_exposure_layers_0001.tif"

# stacked ldr images
LDR_STACK_0=c0018_r0000-c0018_r0001_stack_ldr_0000.tif
LDR_STACK_0_SHELL="c0018_r0000-c0018_r0001_stack_ldr_0000.tif"
LDR_STACK_0_INPUT=c0018_r0000-c0018_r0001_exposure_layers_0000.tif
LDR_STACK_0_INPUT_SHELL="c0018_r0000-c0018_r0001_exposure_layers_0000.tif"
LDR_STACK_1=c0018_r0000-c0018_r0001_stack_ldr_0001.tif
LDR_STACK_1_SHELL="c0018_r0000-c0018_r0001_stack_ldr_0001.tif"
LDR_STACK_1_INPUT=c0018_r0000-c0018_r0001_exposure_layers_0001.tif
LDR_STACK_1_INPUT_SHELL="c0018_r0000-c0018_r0001_exposure_layers_0001.tif"
...
info : 
	...
	@echo Free space on disc: 19199 MiB
	@echo Active codepage: 1251 (Cyrillic Windows)
	@echo ===========================================================================
	@echo Output options
	@echo ===========================================================================
	@echo Hugin Version: 2012.0.0.a6e4184ad538 built by Matthew Petroff
	@echo Project file: C:\Andruxa\psxdev\CIRCUIT_004\m1\18\c0018_r0000-c0018_r0001.pto
	@echo Output prefix: c0018_r0000-c0018_r0001
	@echo Projection: Rectilinear (0)
	@echo Field of view: 12 x 16
	@echo Canvas dimensions: 1367 x 1828
	@echo Crop area: (115,147) - (1249,1653)
	...
	@echo Image 0: C:\Andruxa\psxdev\CIRCUIT_004\m1\18\c0018_r0000.jpg
	@echo Image 0: Size 1632x1224, Exposure: 0.32
	@echo Image 1: C:\Andruxa\psxdev\CIRCUIT_004\m1\18\c0018_r0001.jpg
	@echo Image 1: Size 1632x1224, Exposure: 0.32

# Rules for ordinary TIFF_m and hdr output

c0018_r0000-c0018_r00010000.tif : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0000.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) $(NONA_LDR_REMAPPED_COMP) -r ldr -m TIFF_m -o $(LDR_REMAPPED_PREFIX_SHELL) -i 0 $(PROJECT_FILE_SHELL)

c0018_r0000-c0018_r0001_hdr_0000.exr : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0000.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) -r hdr -m EXR_m -o $(HDR_STACK_REMAPPED_PREFIX_SHELL) -i 0 $(PROJECT_FILE_SHELL)

c0018_r0000-c0018_r00010001.tif : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0001.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) $(NONA_LDR_REMAPPED_COMP) -r ldr -m TIFF_m -o $(LDR_REMAPPED_PREFIX_SHELL) -i 1 $(PROJECT_FILE_SHELL)

c0018_r0000-c0018_r0001_hdr_0001.exr : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0001.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) -r hdr -m EXR_m -o $(HDR_STACK_REMAPPED_PREFIX_SHELL) -i 1 $(PROJECT_FILE_SHELL)

# Rules for exposure layer output

c0018_r0000-c0018_r0001_exposure_layers_0000.tif : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0000.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) $(NONA_LDR_REMAPPED_COMP) -r ldr -e 0.321077 -m TIFF_m -o $(LDR_EXPOSURE_REMAPPED_PREFIX_SHELL) -i 0 $(PROJECT_FILE_SHELL)

c0018_r0000-c0018_r0001_exposure_layers_0001.tif : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0001.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) $(NONA_LDR_REMAPPED_COMP) -r ldr -e 0.321077 -m TIFF_m -o $(LDR_EXPOSURE_REMAPPED_PREFIX_SHELL) -i 1 $(PROJECT_FILE_SHELL)
