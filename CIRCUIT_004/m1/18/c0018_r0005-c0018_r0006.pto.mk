...
NONA_OPTS=
ENBLEND_OPTS= -f1821x1661+188+277
...
EXIFTOOL_INFO_ARGS="-Software=Hugin 2012.0.0.a6e4184ad538 built by Matthew Petroff" "-UserComment<$${UserComment}&\#xd;&\#xa;Projection: Rectilinear (0)&\#xd;&\#xa;FOV: 5 x 5&\#xd;&\#xa;Ev: 0.25" -f

# the output panorama
LDR_REMAPPED_PREFIX=c0018_r0005-c0018_r0006
LDR_REMAPPED_PREFIX_SHELL="c0018_r0005-c0018_r0006"
HDR_STACK_REMAPPED_PREFIX=c0018_r0005-c0018_r0006_hdr_
HDR_STACK_REMAPPED_PREFIX_SHELL="c0018_r0005-c0018_r0006_hdr_"
LDR_EXPOSURE_REMAPPED_PREFIX=c0018_r0005-c0018_r0006_exposure_layers_
LDR_EXPOSURE_REMAPPED_PREFIX_SHELL="c0018_r0005-c0018_r0006_exposure_layers_"
PROJECT_FILE=C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0005-c0018_r0006.pto
PROJECT_FILE_SHELL="C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0005-c0018_r0006.pto"
LDR_BLENDED=c0018_r0005-c0018_r0006.tif
LDR_BLENDED_SHELL="c0018_r0005-c0018_r0006.tif"
LDR_STACKED_BLENDED=c0018_r0005-c0018_r0006_fused.tif
LDR_STACKED_BLENDED_SHELL="c0018_r0005-c0018_r0006_fused.tif"
LDR_EXPOSURE_LAYERS_FUSED=c0018_r0005-c0018_r0006_blended_fused.tif
LDR_EXPOSURE_LAYERS_FUSED_SHELL="c0018_r0005-c0018_r0006_blended_fused.tif"
HDR_BLENDED=c0018_r0005-c0018_r0006_hdr.exr
HDR_BLENDED_SHELL="c0018_r0005-c0018_r0006_hdr.exr"

# first input image
INPUT_IMAGE_1=C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0005.jpg
INPUT_IMAGE_1_SHELL="C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0005.jpg"

# all input images
INPUT_IMAGES=C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0005.jpg\
C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0006.jpg
INPUT_IMAGES_SHELL="C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0005.jpg"\
"C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0006.jpg"

# remapped images
LDR_LAYERS=c0018_r0005-c0018_r00060000.tif\
c0018_r0005-c0018_r00060001.tif
LDR_LAYERS_SHELL="c0018_r0005-c0018_r00060000.tif"\
"c0018_r0005-c0018_r00060001.tif"

# remapped images (hdr)
HDR_LAYERS=c0018_r0005-c0018_r0006_hdr_0000.exr\
c0018_r0005-c0018_r0006_hdr_0001.exr
HDR_LAYERS_SHELL="c0018_r0005-c0018_r0006_hdr_0000.exr"\
"c0018_r0005-c0018_r0006_hdr_0001.exr"

# remapped maxval images
HDR_LAYERS_WEIGHTS=c0018_r0005-c0018_r0006_hdr_0000_gray.pgm\
c0018_r0005-c0018_r0006_hdr_0001_gray.pgm
HDR_LAYERS_WEIGHTS_SHELL="c0018_r0005-c0018_r0006_hdr_0000_gray.pgm"\
"c0018_r0005-c0018_r0006_hdr_0001_gray.pgm"

# stacked hdr images
HDR_STACK_0=c0018_r0005-c0018_r0006_stack_hdr_0000.exr
HDR_STACK_0_SHELL="c0018_r0005-c0018_r0006_stack_hdr_0000.exr"
HDR_STACK_0_INPUT=c0018_r0005-c0018_r0006_hdr_0000.exr
HDR_STACK_0_INPUT_SHELL="c0018_r0005-c0018_r0006_hdr_0000.exr"
HDR_STACK_1=c0018_r0005-c0018_r0006_stack_hdr_0001.exr
HDR_STACK_1_SHELL="c0018_r0005-c0018_r0006_stack_hdr_0001.exr"
HDR_STACK_1_INPUT=c0018_r0005-c0018_r0006_hdr_0001.exr
HDR_STACK_1_INPUT_SHELL="c0018_r0005-c0018_r0006_hdr_0001.exr"
...
LDR_EXPOSURE_LAYER_0=c0018_r0005-c0018_r0006_exposure_0000.tif
LDR_EXPOSURE_LAYER_0_SHELL="c0018_r0005-c0018_r0006_exposure_0000.tif"
LDR_EXPOSURE_LAYER_0_INPUT=c0018_r0005-c0018_r0006_exposure_layers_0000.tif\
c0018_r0005-c0018_r0006_exposure_layers_0001.tif
LDR_EXPOSURE_LAYER_0_INPUT_SHELL="c0018_r0005-c0018_r0006_exposure_layers_0000.tif"\
"c0018_r0005-c0018_r0006_exposure_layers_0001.tif"
LDR_EXPOSURE_LAYER_0_INPUT_PTMENDER=c0018_r0005-c0018_r00060000.tif\
c0018_r0005-c0018_r00060001.tif
LDR_EXPOSURE_LAYER_0_INPUT_PTMENDER_SHELL="c0018_r0005-c0018_r00060000.tif"\
"c0018_r0005-c0018_r00060001.tif"
LDR_EXPOSURE_LAYER_0_EXPOSURE=0.250705
...
LDR_EXPOSURE_LAYERS_REMAPPED=c0018_r0005-c0018_r0006_exposure_layers_0000.tif\
c0018_r0005-c0018_r0006_exposure_layers_0001.tif
LDR_EXPOSURE_LAYERS_REMAPPED_SHELL="c0018_r0005-c0018_r0006_exposure_layers_0000.tif"\
"c0018_r0005-c0018_r0006_exposure_layers_0001.tif"

# stacked ldr images
LDR_STACK_0=c0018_r0005-c0018_r0006_stack_ldr_0000.tif
LDR_STACK_0_SHELL="c0018_r0005-c0018_r0006_stack_ldr_0000.tif"
LDR_STACK_0_INPUT=c0018_r0005-c0018_r0006_exposure_layers_0000.tif
LDR_STACK_0_INPUT_SHELL="c0018_r0005-c0018_r0006_exposure_layers_0000.tif"
LDR_STACK_1=c0018_r0005-c0018_r0006_stack_ldr_0001.tif
LDR_STACK_1_SHELL="c0018_r0005-c0018_r0006_stack_ldr_0001.tif"
LDR_STACK_1_INPUT=c0018_r0005-c0018_r0006_exposure_layers_0001.tif
LDR_STACK_1_INPUT_SHELL="c0018_r0005-c0018_r0006_exposure_layers_0001.tif"
...
info : 
	...
	@echo Free space on disc: 19177 MiB
	@echo Active codepage: 1251 (Cyrillic Windows)
	@echo ===========================================================================
	@echo Output options
	@echo ===========================================================================
	@echo Hugin Version: 2012.0.0.a6e4184ad538 built by Matthew Petroff
	@echo Project file: C:\Andruxa\psxdev\CIRCUIT_004\m1\18\c0018_r0005-c0018_r0006.pto
	@echo Output prefix: c0018_r0005-c0018_r0006
	@echo Projection: Rectilinear (0)
	@echo Field of view: 5 x 5
	@echo Canvas dimensions: 2215 x 2215
	@echo Crop area: (188,277) - (2009,1938)
	@echo Output exposure value: 0.25
	...
	@echo Image 0: C:\Andruxa\psxdev\CIRCUIT_004\m1\18\c0018_r0005.jpg
	@echo Image 0: Size 1632x1224, Exposure: 0.25
	@echo Image 1: C:\Andruxa\psxdev\CIRCUIT_004\m1\18\c0018_r0006.jpg
	@echo Image 1: Size 1632x1224, Exposure: 0.25

# Rules for ordinary TIFF_m and hdr output

c0018_r0005-c0018_r00060000.tif : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0005.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) $(NONA_LDR_REMAPPED_COMP) -r ldr -m TIFF_m -o $(LDR_REMAPPED_PREFIX_SHELL) -i 0 $(PROJECT_FILE_SHELL)

c0018_r0005-c0018_r0006_hdr_0000.exr : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0005.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) -r hdr -m EXR_m -o $(HDR_STACK_REMAPPED_PREFIX_SHELL) -i 0 $(PROJECT_FILE_SHELL)

c0018_r0005-c0018_r00060001.tif : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0006.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) $(NONA_LDR_REMAPPED_COMP) -r ldr -m TIFF_m -o $(LDR_REMAPPED_PREFIX_SHELL) -i 1 $(PROJECT_FILE_SHELL)

c0018_r0005-c0018_r0006_hdr_0001.exr : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0006.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) -r hdr -m EXR_m -o $(HDR_STACK_REMAPPED_PREFIX_SHELL) -i 1 $(PROJECT_FILE_SHELL)

# Rules for exposure layer output

c0018_r0005-c0018_r0006_exposure_layers_0000.tif : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0005.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) $(NONA_LDR_REMAPPED_COMP) -r ldr -e 0.250705 -m TIFF_m -o $(LDR_EXPOSURE_REMAPPED_PREFIX_SHELL) -i 0 $(PROJECT_FILE_SHELL)

c0018_r0005-c0018_r0006_exposure_layers_0001.tif : C:/Andruxa/psxdev/CIRCUIT_004/m1/18/c0018_r0006.jpg $(PROJECT_FILE) 
	$(NONA) $(NONA_OPTS) $(NONA_LDR_REMAPPED_COMP) -r ldr -e 0.250705 -m TIFF_m -o $(LDR_EXPOSURE_REMAPPED_PREFIX_SHELL) -i 1 $(PROJECT_FILE_SHELL)
